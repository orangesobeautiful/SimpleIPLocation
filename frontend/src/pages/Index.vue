    ...
    <div class="column page-div">
      <div class="col-2">
        <div class="row">
          <div class="col">
            <div class="column">
              <div class="text-h6 text-black text-center item-center">
                IP 查詢
              </div>
              <q-input
                v-model="ipQuery"
  ...
  methods: {
    getIPInfo() {
      ...
      axios.get(path).then(res => {
        ...
        this.mapCenter = new L.LatLng(this.latitude, this.longitude);
        this.mapMark = new L.LatLng(this.latitude, this.longitude);
      });
    }
  }
};
